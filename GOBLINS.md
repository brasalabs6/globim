...
- The public npm package is `goblins`.
- The public CLI command is `goblin`.
- The `goblins` command is reserved for a future multi-agent interface.
- Platform packages use unscoped names: `goblins-linux-x64`, `goblins-linux-arm64`, `goblins-darwin-x64`, `goblins-darwin-arm64`, `goblins-win32-x64`, and `goblins-win32-arm64`.
