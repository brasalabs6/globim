...
- Platform packages use scoped names: `@brasalabs/goblins-linux-x64`, `@brasalabs/goblins-linux-arm64`, `@brasalabs/goblins-win32-x64`, and `@brasalabs/goblins-win32-arm64`.
