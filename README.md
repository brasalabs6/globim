...
Goblins `0.130.1` is based on upstream `rust-v0.130.0` / `@openai/codex@0.130.0`, the latest stable release verified for this fork update via the upstream [GitHub release](https://github.com/openai/codex/releases/tag/rust-v0.130.0) and [npm package](https://www.npmjs.com/package/@openai/codex/v/0.130.0).
