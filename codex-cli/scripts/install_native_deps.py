...
DEFAULT_WORKFLOW_URL = "https://github.com/brasalabs6/goblins/actions"  # Override with a rust-release run URL for releases.
...
def _download_artifacts(workflow_id: str, dest_dir: Path) -> None:
    cmd = [
        ...
        str(dest_dir),
        "--repo",
        os.environ.get("GITHUB_REPOSITORY", "brasalabs6/goblins"),
        workflow_id,
    ]
