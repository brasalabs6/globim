...
release_url_for_asset() {
  ...
  printf 'https://github.com/brasalabs6/goblins/releases/download/rust-v%s/%s\n' "$resolved_version" "$asset"
}
...
resolve_version() {
  ...
  release_json="$(download_text "https://api.github.com/repos/brasalabs6/goblins/releases/latest")"
